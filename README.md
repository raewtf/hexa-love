...
If you wanna play this game, it's available for purchase [here](https://rae.wtf/games/hexa). Or, if you just LOVE command line tools and HATE paying money for things: drop in your own copy of the luasteam library (preferably v3.2.1), compress the contents, use `love` to run the program, and enjoy!